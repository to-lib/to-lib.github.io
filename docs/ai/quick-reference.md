...
| 模型                   | 价格      | 维度 |
| ---------------------- | --------- | ---- |
| text-embedding-3-small | $0.02/1M  | 1536 |
| text-embedding-3-large | $0.13/1M  | 3072 |
...
_价格单位：美元，数据更新于 2025 年 1 月_

## 模型选择指南

| 场景           | 推荐模型          | 备选              |
| -------------- | ----------------- | ----------------- |
| 日常对话       | GPT-4o-mini       | Claude 3.5 Haiku  |
| 复杂推理       | o1 / GPT-4o       | Claude 3.5 Sonnet |
| 代码生成       | Claude 3.5 Sonnet | GPT-4o            |
| 长文档处理     | Claude 3.5 Sonnet | Gemini 1.5 Pro    |
| 图像理解       | GPT-4o            | Claude 3.5 Sonnet |
| 成本敏感       | GPT-4o-mini       | Claude 3.5 Haiku  |
| 中文优化       | Qwen2.5           | DeepSeek          |
