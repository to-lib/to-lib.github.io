...
> [!TIP]
> 本面试题库汇集了各技术领域的高频面试题，帮助你系统性地准备技术面试。
...
| [设计模式面试题](/docs/interview/java-design-patterns-interview-questions) | ⭐⭐⭐   | 23 种设计模式及应用场景         |
...
| 主题                                                                | 难度       | 说明                            |
| ------------------------------------------------------------------- | ---------- | ------------------------------- |
| [系统设计面试题](/docs/interview/system-design-interview-questions) | ⭐⭐⭐⭐⭐ | CAP、负载均衡、缓存、高并发架构 |
| [行为面试题 (BQ)](/docs/interview/behavioral-interview-questions)   | ⭐⭐⭐     | STAR 法则、领导力、项目经验     |
