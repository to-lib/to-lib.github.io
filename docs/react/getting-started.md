...
1. [组件基础](./components) - 深入理解组件
2. [JSX 语法](./jsx) - JSX 详细用法
3. [Props 和 State](./props-state) - 组件通信和状态
...
**A**: React 通过首字母大小写区分组件和 HTML 标签：

- 小写 `<div>` - HTML 元素
- 大写 `<MyComponent>` - React 组件

### Q: key 属性有什么用？

**A**: `key` 帮助 React 识别列表中的元素，提高渲染性能，必须唯一且稳定。

---

**恭喜！** 您已经创建了第一个 React 应用！继续学习 [组件基础](./components) 深入理解 React。
