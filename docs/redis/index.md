...
1. [Redis 简介](/docs/redis/introduction) - 了解 Redis 基本概念和特点
2. [数据类型](/docs/redis/data-types) - 掌握各种数据类型的使用
3. [持久化](/docs/redis/persistence) - 理解数据持久化机制
4. [主从复制](/docs/redis/replication) - 学习主从复制原理
5. [缓存策略](/docs/redis/cache-strategies) - 掌握常见缓存问题解决方案
...
| [哨兵模式](/docs/redis/sentinel)                 | 哨兵架构、故障转移、高可用配置         |
| [Redis 集群](/docs/redis/cluster)                | 集群架构、数据分片、槽位管理           |
